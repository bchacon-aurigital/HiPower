...
export default function Hero() {
  ...
  return (
    <>
      <div className="flex items-center justify-center h-screen mb-8" role="main">
        <section
          className="relative w-[96%] rounded-3xl h-[94vh] overflow-hidden mx-auto my-auto"
        ...
        >
          ...
          <div className="absolute inset-0" aria-hidden="true">
            <picture>
              ...
              />
              <source
                srcSet="/assets/landing/HeroBGMobile.avif"
                type="image/avif"
                media="(max-width: 767px)"
              />
              <source
                srcSet="/assets/landing/HeroBGMobile.png"
                type="image/png"
                media="(max-width: 767px)"
              />
              <Image
          ...
          {/* Logo */}
          <div
            className="absolute w-full mt-3 flex justify-center lg:justify-start lg:mt-0 lg:absolute lg:top-8 lg:left-8"
            aria-hidden="true"
          >
            <Image
          ...
          >
            ...
            <div className="w-full xl:block hidden mt-[5%]" role="region" aria-labelledby="stats-heading">
              <div className="flex flex-row px-4 w-full justify-center items-center">
                <h2
                  id="stats-heading"
                  className="text-2xl md:text-[2.50rem] font-bold max-w-sm leading-tight mr-5"
                >
                  ¿Por qué somos el aliado ideal para tu empresa?
                </h2>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl" role="list">
                  {/* Stat 1 */}
                  <div
                    className="relative bg-white/10 backdrop-blur-md rounded-tl-3xl rounded-br-3xl py-8 text-center px-10 transition-all duration-500 group overflow-hidden"
                    role="listitem"
                  >
                    <span className="absolute inset-0 bg-gradient-to-r from-[#037F3F] to-[#002D6A] opacity-0 transition-opacity duration-500 group-hover:opacity-100"></span>
                    <h3 className="text-4xl font-bold mb-2 relative z-10 font-roboto">3 años</h3>
                    <p className="text-md relative z-10 font-roboto font-[200]">
                      de experiencia en proyectos solares estratégicos.
                    </p>
                  </div>
                  ...
                  >
                    ...
                    <p className="text-md relative z-10 font-roboto font-[200]">
                      instalados en proyectos fotovoltaicos exitosos.
                    </p>
                  </div>
                  ...
                  >
                    ...
                    <p className="text-md relative z-10 font-roboto font-[200]">
                      en sistemas avanzados de almacenamiento de energía.
                    </p>
                  </div>
                </div>
              </div>
