...
const proyectos = [
  {
    ...
    icono: (
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" role="img">
    ...
    imagenPrincipal: "/assets/landing/brands/image 7.avif",
    imagenesSecundarias: [
      "/assets/landing/brands/image 8.avif",
      "/assets/landing/brands/image 9.avif",
      "/assets/landing/brands/image 10.avif"
    ],
  ...
  },
  {
    ...
    imagenPrincipal: "/assets/escuelas-indigenas.jpg",
    imagenesSecundarias: [
      "/assets/escuelas-1.jpg",
      "/assets/escuelas-2.jpg",
      "/assets/escuelas-3.jpg"
    ],
  ...
  },
  {
    ...
    imagenPrincipal: "/assets/hospitales.jpg",
    imagenesSecundarias: [
  ...
  },
  {
    ...
    imagenPrincipal: "/assets/cence.jpg",
    imagenesSecundarias: [
      "/assets/cence-1.jpg",
      "/assets/cence-2.jpg",
      "/assets/cence-3.jpg"
  ...
  },
  {
    ...
    imagenPrincipal: "/assets/casa-santuario.jpg",
    imagenesSecundarias: [
      "/assets/casa-1.jpg",
      "/assets/casa-2.jpg",
      "/assets/casa-3.jpg"
  ...
  return (
    <article className="w-full p-4 rounded-lg shadow-sm max-w-7xl mx-auto mt-16" id={`proyecto-${id}`} role="region" aria-label={`Proyecto: ${titulo}`}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-2 mb-6 lg:max-h-[400px]">
        ...
        <div className="col-span-1 grid grid-cols-3 lg:grid-cols-1 gap-2">
          {imagenesSecundarias.map((img, index) => (
            <div key={index} className="h-[128px] overflow-hidden" data-aos="zoom-in" data-aos-delay={100 * (index + 1)}>
              <Image 
                src={img} 
      ...
      <div className="mb-6" role="region" aria-label="Características técnicas">
        <div className="flex items-center gap-2 mb-4" data-aos="fade-right">
          <div className="text-gray-500 bg-white border border-[#C9C9C9] p-2 rounded-lg" aria-hidden="true">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
