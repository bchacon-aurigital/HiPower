        ...
        <div className="grid sm:grid-cols-4 md:grid-cols-6 border border-[#C9C9C9]">
          ...
          >
            <div className="w-10 h-10 text-xl rounded-full bg-[#037F3F] text-white flex items-center justify-center font-bold mb-4">
              <img src="../assets/servicios/iconos/material-symbols_draw.svg" className='w-6 h-6' alt='conceptualizacion'/>
            </div>
          ...
          >
            <div className="w-10 h-10 text-xl  rounded-full bg-[#037F3F] text-white flex items-center justify-center font-bold mb-4">
            <img src="../assets/servicios/iconos/Vector (1).svg" className='w-6 h-6' alt='diseño'/>
            </div> 
          ...
          >
            <div className="w-10 h-10 text-xl rounded-full bg-[#037F3F] text-white flex items-center justify-center font-bold mb-4">
            <img src="../assets/servicios/iconos/Vector (3).svg" className='w-6 h-6' alt='financiamiento'/>
            </div>
          ...
          >
            <div className="w-10 h-10 text-xl rounded-full bg-[#037F3F] text-white flex items-center justify-center font-bold mb-4">
            <img src="../assets/servicios/iconos/mdi_build.svg" className='w-6 h-6' alt='instalacion'/>
            </div>
          ...
          >
            <div className="w-10 h-10 text-xl rounded-full bg-[#037F3F] text-white flex items-center justify-center font-bold mb-4">
            <img src="../assets/servicios/iconos/Vector (5).svg" className='w-6 h-6' alt='marcha'/>
            </div>
          ...
          >
            <div className="w-10 h-10 text-xl rounded-full bg-[#037F3F] text-white flex items-center justify-center font-bold mb-4">
            <img src="../assets/servicios/iconos/Vector (6).svg" className='w-6 h-6' alt='soporte'/>
            </div>
